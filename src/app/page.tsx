  ...
  const QuickTool = ({ href, icon: Icon, label, color }: any) => (
    <Link href={href}>
      <motion.div 
        ...
        whileTap={{ scale: 0.95 }}
        className="flex flex-col items-center gap-2 p-4 glass-card rounded-3xl"
      >
                  ...
                  >
                    {[
                      ...
                      >
                        ...
                        <p className="text-2xl font-black text-primary truncate">{formatNumber(res.value)}</p>
                      </motion.div>
                    ))}
                  </motion.div>
                )}
                ...
                <div className="space-y-3">
                  {history.map((item, idx) => (
                    <motion.div 
                      ...
                      className="p-5 bg-muted/30 rounded-[1.5rem] border border-white/50 flex items-center justify-between group hover:bg-white dark:hover:bg-slate-800 transition-colors shadow-sm"
                    >
